...
namespace Tyuiu.RyabtsevNE.Sprint4.Task1.V1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Выполнила: Рябцев Н. Е. | СМАРТб-24-1";
            ...
            Console.WriteLine("* Выполнила: Рябцев Никита Евгеньевич | СМАРТь-24-1                       *");
            Console.WriteLine("***************************************************************************");
